cheatsheet do
  ...
  notes <<-'END'
    * Based on the cheat sheet from [IntelliJ Default Keymap](http://www.jetbrains.com/phpstorm/documentation/IntelliJ_ReferenceCard.pdf).
